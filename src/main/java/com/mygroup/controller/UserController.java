			...
			logger.debug("valid user is available");
			 ...
			 //select * from proj2_profile_pics where username='adam';
		  	...
		  	try{
		  		...
		  		String path="D:/SecondProject2/group1/src/main/webapp/resources/images/users/"+validuser.getUserid()+".jpg";
	...
	public ResponseEntity<?> logout(HttpSession session){
		...
		if(ud!=null){
			...
			try{
				...
				String path="D:/SecondProject2/group1/src/main/webapp/resources/images/users/"+ud.getUserid()+".jpg";
				File file=new File(path);
